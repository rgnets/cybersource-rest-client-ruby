...
module CyberSource
  class Ptsv2paymentsPaymentInformationLegacyToken
    ...
    def list_invalid_properties
      ...
      # if !@id.nil? && @id.to_s.length > 22
        # invalid_properties.push('invalid value for "id", the character length must be smaller than or equal to 22.')
      # end
    ...
    def valid?
      # return false if !@id.nil? && @id.to_s.length > 22
    ...
    def id=(id)
      # if !id.nil? && id.to_s.length > 22
        # fail ArgumentError, 'invalid value for "id", the character length must be smaller than or equal to 22.'
      # end
