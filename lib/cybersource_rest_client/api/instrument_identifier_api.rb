...
module CyberSource
  class InstrumentIdentifierApi
    ...
    # @return [PaymentInstrumentsList200Response]
    ...
    # @return [Array<(PaymentInstrumentsList200Response, Fixnum, Hash)>] PaymentInstrumentsList200Response data, response status code and response headers
    def get_instrument_identifier_payment_instruments_list_with_http_info(instrument_identifier_token_id, opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'PaymentInstrumentsList200Response')
      if @api_client.config.debugging
		begin
		raise
