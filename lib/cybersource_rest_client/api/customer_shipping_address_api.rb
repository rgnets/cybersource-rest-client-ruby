...
module CyberSource
  class CustomerShippingAddressApi
    ...
    # @return [CustomerShippingAddressesListGet200Response]
    ...
    # @return [Array<(CustomerShippingAddressesListGet200Response, Fixnum, Hash)>] CustomerShippingAddressesListGet200Response data, response status code and response headers
    def get_customer_shipping_addresses_list_with_http_info(customer_token_id, opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'CustomerShippingAddressesListGet200Response')
      if @api_client.config.debugging
		begin
		raise
