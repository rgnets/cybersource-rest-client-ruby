...
module CyberSource
  class CustomerApi
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :profile_id The id of a profile containing user specific TMS configuration.
    # @return [Array<(CustomerPost200Response, Fixnum, Hash)>] CustomerPost200Response data, response status code and response headers
    def get_customer_with_http_info(customer_token_id, opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'CustomerPost200Response')
      if @api_client.config.debugging
		begin
		raise
